...
| 7 | CSS teknik borcu — `.costera-sidebar-brand` iki kez çakışan tanımla (satır 3019 ve 6594); taşan kartlar, "saçma oklar", "dümdüz logo" bunun sonucu | `app/globals.css` | **Faz 1** | 🟡 Devam ediyor — sidebar logosu düzgün doğrulandı; source-kartı okları (gap ile) düzeltildi; entegrasyon scroll bozukluğu tarayıcı-pane artefaktı çıktı (gerçek hata değil). Kalan: pos/inventory/recipes/purchasing/reports/variance/finance sayfalarının görsel taraması |
